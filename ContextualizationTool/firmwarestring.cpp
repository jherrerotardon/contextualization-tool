...
FirmwareString::FirmwareString(QString &id, QString &value, QString &description, int maxLength, QString &state, bool selected)
{
    this->id = id;
    this->value = value;
...
int FirmwareString::getMaxLength() const
{
